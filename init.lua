...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch Fuzzily search in [C]urrent buffer' })

      -- It's also posscble to pass additional configuration options.
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local extra_timeout_filetypes = { sql = true }
        if disable_filetypes[vim.bo[bufnr].filetype] then
          return nil
        elseif extra_timeout_filetypes[vim.bo[bufnr].filetype] then
          return {
            timeout_ms = 1000,
            lsp_format = 'fallback',
          }
